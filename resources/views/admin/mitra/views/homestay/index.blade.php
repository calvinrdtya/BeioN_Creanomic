        ...
        <div class="layout-page">
            ...
            <div class="content-wrapper">
                ...
                <div class="container-xxl flex-grow-1 container-p-y">
                    <h4 class="fw-bold"><span class="text-muted fw-light">Homestay / </span>Mitra</h4>
                            ...
                            <table class="table">
                                ...
                                <tbody class="table-border-bottom-0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.mitra.homestay.detail', $mitra->id) }}" class="btn btn-sm btn-outline-primary me-1">
