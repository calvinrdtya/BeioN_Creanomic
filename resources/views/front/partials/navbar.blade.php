...
<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light scrolled awake" id="ftco-navbar">
    <div class="container">
        <a class="navbar-brand" href="{{ route('front.home') }}">
            <img src="{{ asset('front-assets/img/logo/Logo.png') }}" alt="logo" width="90">
        </a>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto align-items-center">
                ...
                <li class="nav-item d-flex justify-content-center align-items-center">
                    <a href="#" class="nav-link btn btn-login border-0 px-2 mr-2"><i class="mr-2 fas fa-user"></i>Login</a>
                </li>
                <li class="nav-item d-flex justify-content-center align-items-center">
                    <a href="{{ route('account.register') }}" class="nav-link btn btn-register border-0 px-2 mr-2">Daftar</a>
                </li>
                @endguest
                @auth
                    <li class="nav-item">
