...
<div class="container pb-5">
    ...
    <div class="container" style="width: 90%;">
        <form action="{{ route('transportasi.booking.store', $transportasi->id) }}" method="POST">
            @csrf
            <div class="row">
                        ...
                        <div class="card p-3">
                            ...
                            <div class="card p-1 mt-4">
                                <div class="card-body">
                                    ...
                                    <hr class="mb-3 mt-3">
                                    <a href="{{ route('transportasi.review') }}" class="button-booking border-0 w-100">Lanjutkan</a>
                                </div>
                            </div>
                        </div>
                    </div>
