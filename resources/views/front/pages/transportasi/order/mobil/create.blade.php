...
<div class="container pb-5">
    ...
    <div class="container" style="width: 90%;">
        <form action="{{ route('mobil.booking.store', $mobil->id) }}" method="POST">
            @csrf
            <div class="row">
                        ...
                        <h4 class="title-booking mb-3">Detail Pemesan</h4>
                            <div class="card p-3 rounded-2">
                                ...
                                <div class="row my-3">
                                    ...
                                    <input type="hidden" name="grand_total" value="{{ $mobil->final_price }}">
                                    <div class="col-md-2">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card p-1 rounded-2">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-center">
                                @if ($mobil->image)
                                    <img src="{{ asset('img/' . $mobil->image) }}" alt="mobil Image" class="rounded-2" width="50%">
                                @else
                                    <img src="{{ asset('front-assets/img_blank.jpg') }}" alt="Default Image"/>
                                @endif
                            </div>
                            <div class="my-2">
                                <span class="title-booking-three d-block text-capitalize">{{ $mobil->title }}</span>
                            </div>
                            <div class="my-2">
                                <span class="title-booking-three d-block">Disediakan oleh {{ $mobil->mitra->name }}</span>
                                {{-- <span class="title-booking-secondary d-block text-capitalize">{{ $mobil->title }}</span> --}}
                            </div>
                        </div>
                    </div>
                    <div class="card p-1 my-4">
                        <div class="card-body">
                            ...
                            <div class="form-group form-group-perjalanan my-2">
                                ...
                                <input type="text" id="tgl_pinjam_mobil" name="tgl_pinjam" class="form-control nav-group-mvp" required>
                            </div>
                            <div class="form-group form-group-perjalanan my-2">
                                ...
                                <input type="text" id="tgl_pengembalian_mobil" name="tgl_pengembalian" class="form-control nav-group-mvp" required>
                            </div>
                            <div class="form-group form-group-perjalanan my-2">
                    ...
                    <div class="card p-1 mt-4">
                        ...
                        <hr class="my-3">
                            <div class="my-2">
                                <h6 class="title-book">1x {{ $mobil->title }}</h6>
                            </div>
                            <div class="my-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    ...
                                    @else
                                        <span class="title-booking-three d-block">{{ $mobil->price_discount }}%</span>
                                    @endif
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                            ...
                            @else
                                <div class="text-end">
                                    <h5 class="price-sub text-decoration-line-through mb-0">Rp {{ $mobil->price }}</h5>
                                </div>
                            @endif
...
<script>
    ...
    $(function() {
        ...
        $('input[id="tgl_pinjam_mobil"], input[id="tgl_pengembalian_mobil"]').daterangepicker({
        ...
        // Event listener untuk update input tgl_pinjam_mobil dan tgl_pengembalian_mobil
        $('input[id="tgl_pinjam_mobil"], input[id="tgl_pengembalian_mobil"]').on('apply.daterangepicker', function(ev, picker) {
            var startDate = formatDate(picker.startDate.format('YYYY-MM-DD'));
            var endDate = formatDate(picker.endDate.format('YYYY-MM-DD'));
            
            $('#tgl_pinjam_mobil').val(startDate);
            $('#tgl_pengembalian_mobil').val(endDate);
        ...
        $('input[id="tgl_pinjam_mobil"], input[id="tgl_pengembalian_mobil"]').on('cancel.daterangepicker', function(ev, picker) {
            $(this).val('');
            $('.badge').text('0 Hari');
