          ...
          <div class="offcanvas-body d-flex flex-column flex-lg-row p-lg-0 p-4">
            <ul class="navbar-nav justify-content-center align-items-center flex-grow-1 pe-3">
              <div class="card p-1 rounded-pill card-group-homestay">
                ...
                <input type="text" class="form-control form-md border-0" id="tgl_pinjam" placeholder="Pinjam" readonly aria-label="Pinjam" style="cursor: pointer; width: 120px; box-shadow: none !important;">
                <span class="badge bg-first rounded-2" style="background-color: #4154f1; color: white; margin: 0 10px;">0 Hari</span>
                <input type="text" class="form-control form-md border-0" id="tgl_pengembalian" placeholder="Pengembalian" readonly aria-label="Pengembalian" style="cursor: pointer; width: 120px; box-shadow: none !important;">
                <div style="border-left: 1px solid #bfbfbf; height: 27px; margin: 0 10px;"></div>
                    <div class="nav-item dropdown position-relative">
            ...
            @guest
              <div class="d-flex flex-lg-row flex-column justify-content-center align-items-center gap-3">
                ...
                <a class="getsignup" href="">Sign Up</a>
