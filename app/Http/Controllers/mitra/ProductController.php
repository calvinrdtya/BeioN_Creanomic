...
class ProductController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $products = Product::where('mitra_id', $userId)->oldest('id')->with('product_images');
        ...
        return view('mitra.product.index',$data);
    }
    ...
    public function create(){
        ...
        $data['brands'] = $brands;
        return view('mitra.product.create', $data);
    }
    ...
    public function edit($id, Request $request){
        ...
        return view('mitra.product.edit', $data);
    }
    ...
    public function export_pdf()
    {
        ...
        // Generate the PDF
        $pdf = PDF::loadView('mitra.report.product', compact('data'));
