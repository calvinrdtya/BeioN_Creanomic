...
class DiscountCodeController extends Controller
{
    public function index(Request $request){
        ...
        return view('mitra.coupon.list',compact('discountCoupons'));
    }

    public function create(){
        return view('mitra.coupon.create');
    }
    ...
    public function edit(Request $request, $id){
        ...
        return view('mitra.coupon.edit', $data);
    ...
    public function export_pdf()
    {
        ...
        // Generate the PDF
        $pdf = PDF::loadView('mitra.report.coupon', compact('data'));
