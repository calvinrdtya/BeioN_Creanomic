...
class BrandController extends Controller
{
    ...
    public function index(Request $request) {
        ...
        return view('mitra.brands.list', compact('brands'));

    }

    public function create() {
        return view('mitra.brands.create');
    }
    ...
    public function edit($id, Request $request) {
        ...
        $data['brand'] = $brand;
        return view('mitra.brands.edit',$data);
    }
    ...
    public function export_pdf()
    {
        ...
        // Generate the PDF
        $pdf = PDF::loadView('mitra.report.brand', compact('data'));
